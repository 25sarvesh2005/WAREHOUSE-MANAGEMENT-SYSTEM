...
5. Use the direct Supabase connection for both URLs when IPv6 is available. On
...
credentials in `backend/.env` or the deployment secret manager; never commit them or
